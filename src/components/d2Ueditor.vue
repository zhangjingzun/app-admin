<template>
  <vue-ueditor-wrap ref="ueditor" v-model="msg" :destroy="false" :config="config" @ready="ready" @beforeInit="addCustomUI"></vue-ueditor-wrap>
</template>
  ...
  data () {
    return {
      ...
      config: {
        ...
        serverUrl: 'http://app.admin.test/controller.php'
